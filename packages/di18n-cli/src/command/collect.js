 ...
 */
async function collectChineseWords(option, publish, notEditCode, confService) {
  ...
  // TODOLYM1: 扫描文件后通过遍历的方式，每个文件找中文并替换
...
module.exports = function doCollectChineseWords(
  ...
  return collectChineseWords(options, publish, notEditCode, confService);
};
